...
class Aplicacion:
    def __init__(self):
        self.ventana1=tk.Tk()
        self.crear_botones()
        self.canvas1=tk.Canvas(self.ventana1, width=600, height=400, background="wheat2")
        self.canvas1.grid(column=0, row=1)
        self.linea=self.canvas1.create_line(0, 0, 100,50, fill="black")        
        self.rectangulo=self.canvas1.create_rectangle(150,10, 300,110, fill="purple2")
        self.ovalo=self.canvas1.create_oval(400,10,500,150, fill="cyan2")        
