...
class Aplicacion:
    ...
    def entradadatos(self):
        ...
        self.boton1=ttk.Button(self.lf1, text="Crear gráfico", command=self.grafico_barraporcentual)
    ...
    def grafico_barraporcentual(self):
        ...
        self.canvas1.create_rectangle(10,200,10+largo1,260,fill="dodgerblue")
        self.canvas1.create_text(50, 220, text="{0:.2f}".format(porc1)+"%", fill="white", font="Arial")
        self.canvas1.create_rectangle(10+largo1,200,10+largo1+largo2,260,fill="deeppink")
        self.canvas1.create_text(50+largo1, 220, text="{0:.2f}".format(porc2)+"%", fill="white", font="Arial")
        self.canvas1.create_rectangle(10+largo1+largo2,200,10+largo1+largo2+largo3,260,fill="green2")
