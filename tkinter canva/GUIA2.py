...
class Aplicacion:
    def __init__(self):
        self.ventana1=tk.Tk()
        self.entradadatos()
        self.canvas1=tk.Canvas(self.ventana1, width=600, height=400, background="peachpuff")
    ...
    def entradadatos(self):
        ...
        self.boton1=ttk.Button(self.lf1, text="Mostrar gráfico", command=self.grafico_barra)
    ...
    def grafico_barra(self):
        ...
        self.canvas1.create_rectangle(10,10,10+largo1,90,fill="dodgerblue")
        self.canvas1.create_rectangle(10,120,10+largo2,200,fill="deeppink")
        self.canvas1.create_rectangle(10,230,10+largo3,310,fill="green2")
        self.canvas1.create_text(largo1+70, 50, text="Docentes", fill="black", font="Arial")
        self.canvas1.create_text(largo2+70, 160, text="Alumnas", fill="black", font="Arial")
        self.canvas1.create_text(largo3+70, 270, text="Alumnos", fill="black", font="Arial")
