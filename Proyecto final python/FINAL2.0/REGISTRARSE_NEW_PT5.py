...
class aplication15():
    def __init__(self):
        ...
        self.label_mail=tk.Label(self.frame, text="Se ha registrado con éxito.\n Bienvenido a \n''MardelAPP Salud''" ,font=("Sitka Text Semibold", 20), width=500)
        self.label_mail.pack(pady=10)

        self.boton_gmail = ttk.Button(self.frame, width=50, text="CERRAR", image=self.imagen_google_tk, compound="left", command=gmail)
