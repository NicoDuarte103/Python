...
class aplication10():
    def __init__(self):
       ...
       # self.imagen_google = Image.open("imagenes_final2.0/imagenx.png").resize((20, 20))
        ...
        self.label_mail=tk.Label(self.frame, text="Se ha reasignado con éxito.\n su nueva contraseña es:\n''------''" ,font=("Sitka Text Semibold", 20), width=500)
        self.label_mail.pack(pady=10)

        self.boton_gmail = ttk.Button(self.frame, width=50, text="CERRAR", compound="left", command=self.cerrar_recuperar)
    ...
    def cerrar_recuperar(self):
        self.ventana.destroy()
def confirmar_recuperacion_clave():

    ejecutar = aplication10()
